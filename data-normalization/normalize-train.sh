...
paste <( cut -f 1-6 train_to_truecase ) train_to_truecase.norm.tc | python3 fix-sent-caps.py > ts.train_to_truecase.norm.tc
paste <( cut -f 1-6 train_not_to_truecase ) train_not_to_truecase.norm > ts.train_not_to_truecase.norm
