...
parser.add_argument('-s', '--similarities',default="h2strain_sim.npy",help="the npy file with similarity matrix")
...
data = [(a,b,c.strip()) for a,b,c in data]
...
for i in range(len(data)):
    ...
    print(trans,data[i][1],sep="\t",file=sys.stderr)
    s = similarities[i]
